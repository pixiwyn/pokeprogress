    ...
    <div className="grid md:grid-cols-2 md:gap-4 flex-1">
      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm mb-8">// free forever — no card required</p>
          <form className="flex flex-col gap-4">
            <Alert message={alertMessage} />
            <div className="flex flex-col gap-1">
              <label htmlFor="username" className="text-xs tracking-widest">
                USERNAME
              </label>
              <input
                name="username"
              ...
              />
              <span className="text-xs">// visible to others</span>
            </div>
            <div className="flex flex-col gap-1">
            ...
            <button
              onClick={async (e) => {
                ...
                try {
                  const userData = await api('/v1/auth/signup', {
                    method: 'POST',
                    body: {
                      username,
                      email,
              ...
              className="bg-accent text-bg-primary font-bold py-2 rounded hover:opacity-90 transition-opacity mt-4"
            >
              CREATE ACCOUNT
            </button>
